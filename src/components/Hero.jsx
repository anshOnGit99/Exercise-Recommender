  ...
  return (
    <div className='min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[800px] w-full mx-auto p-4'>
      <div className='flex flex-col gap-4'>
        ...
        <h1 className='uppercase font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-8xl'>Swole<span className='text-blue-400'>normous</span></h1>
      </div>
      ...
      {/* <button className='px-8 py-4 rounded-md border-[2px] bg-slade-950 border-blue-400 border-solid blueShadow duration-200'>
        <p>Accepted & Begin</p>
      </button> */}
      <Button func={()=>{
